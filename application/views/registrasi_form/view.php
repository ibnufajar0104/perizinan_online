                ...
                <div class="card  d-flex flex-column align-items-center mt-4">
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            ...
                            <p class="text-center mt-4">Registrasi terlebih dahulu, untuk bisa melakukan login</p>
                            <form method="post" class="form-daftar  p-4">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group mt-4 px-2">
                                            <label for="jenis_pemohon">Nomor WA</label>
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group mt-4 px-2">
                                            <label for="jenis_pemohon"> Email</label>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group mt-4 mb-4 px-2">
