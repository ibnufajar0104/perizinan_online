                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 form-padding">
                            <div class="logo text-center">
                                ...
                                <img src="https://raw.githubusercontent.com/ibnufajar0104/img_statis/main/b9b6479351238932e3e02b0e165f8d0a-removebg-preview.png" alt="" width="110">
                            </div>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group mt-4">
                                            <label for="jenis_pemohon"><?= $this->session->jenis == 2 ? 'Nama' : 'Nama Penanggung Jawab/Pemilik Badan Usaha' ?></label>
                                            <input type="text" name="tblpemohon_nama" id="tblpemohon_nama" class="form-control" required>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <?php if ($this->session->jenis == 1) : ?>
                                            <div class="col-md-12">
                                                <div class="form-group mt-4">
                                                    ...
                                                    <input type="text" name="tblpemohon_noidentitas" id="tblpemohon_noidentitas" class="form-control" required maxlength="16" minlength="16">
                                                </div>
                                            </div>
                                        <?php else : ?>
                                            <div class="col-md-12">
                                                <div class="form-group mt-4">
                                                    ...
                                                    <input type="text" name="tblpemohon_npwp" id="tblpemohon_npwp" class="form-control" required maxlength="16" minlength="15">
                                                </div>
                                            </div>
                                        <?php endif ?>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group mt-4">
                                            ...
                                            <input type="text" name="tblpemohon_telpon" id="tblpemohon_telpon" class="form-control" required>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group mt-4">
                                            <label for="jenis_pemohon"> Email Aktif</label>
                                            <input type="email" name="tblpemohon_email" id="tblpemohon_email" class="form-control" required>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group mt-4">
                                            ...
                                            <textarea name="tblpemohon_alamat" id="tblpemohon_alamat" class="form-control" placeholder="Alamat/RT/RW/Kecamatan/Kelurahan" rows="4" required></textarea>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group mt-4">
                                            ...
                                            <input type="text" name="username" id="username" class="form-control" value="<?= $this->session->username ?>" readonly required>
                                        </div>
                                    </div>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group mt-4">
                                            ...
                                            <input type="password" name="tblpengguna_password" id="tblpengguna_password" class="form-control" required>
                                        </div>
                                    </div>
