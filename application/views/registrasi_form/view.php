                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group mt-4">
                                            ...
                                            <input type="number" name="tblpemohon_telpon" id="tblpemohon_telpon" class="form-control" required>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group mt-4">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                <input type="password" class="form-control" id="tblpengguna_password" name="tblpengguna_password" required>
