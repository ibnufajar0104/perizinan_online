                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 col-12 px-4 pb-4">
                                            <div class="form-group">
                                                ...
                                                <select name="tblizin_id" id="tblizin_id" class="form-control form-control-2 select" required>
                                        ...
                                        <div class="col-md-6 col-12 px-4 pb-4">
                                            <div class="form-group">
                                                ...
                                                <select name="tblizinpermohonan_id" id="tblizinpermohonan_id" class="form-control form-control-2 select" required>
                                                    <option value="">Pilih</option>
                                        ...
                                        <div class="col-md-6 col-12 px-4 pb-4">
                                            <div class="form-group">
                                                ...
                                                <select name="tblkecamatan_id" id="tblkecamatan_id" class="form-control form-control-2 select" required style="height: 200px">
                                                    <option value="">Pilih</option>
